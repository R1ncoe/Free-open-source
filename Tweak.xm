...
[switches addSwitch3:NSSENCRYPT("Crosshair")
  description:NSSENCRYPT("Teleport all enemies to you without them knowing")
];


[switches addSliderSwitch:NSSENCRYPT("Watermark Y:")
...
[switches addSliderSwitch:NSSENCRYPT("Watermark X:")
  description:NSSENCRYPT("Set your custom move speed")
  minimumValue:10
  maximumValue:200
  sliderColor:UIColorFromHex(0xBD0000)
...
static void didFinishLaunching(CFNotificationCenterRef center, void *observer, CFStringRef name, const void *object, CFDictionaryRef info) {
  timer(5) {
    ...
    [alert addButton: NSSENCRYPT("Visit GitHub!") actionBlock: ^(void) {
      [[UIApplication sharedApplication] openURL: [NSURL URLWithString: NSSENCRYPT("https://github.com/R1ncoe")]];
      timer(2) {
        setupMenu();
      });        
    }];

    [alert addButton: NSSENCRYPT("R1ncoe github") actionBlock: ^(void) {
      [[UIApplication sharedApplication] openURL: [NSURL URLWithString: NSSENCRYPT("https://github.com/R1ncoe")]];
      timer(2) {
        setupMenu();
      });        
